...
var operationRolesBearerAuth = map[string][]string{
	APIV1AuthRefreshPostOperation:                          []string{},
	APIV1AuthSignInPostOperation:                           []string{},
	APIV1AuthSignUpPostOperation:                           []string{},
	APIV1CloudStorageMyDownloadIDGetOperation:              []string{},
	APIV1CloudStorageMyFileInfoGetOperation:                []string{},
	APIV1CloudStorageMyGetOperation:                        []string{},
	APIV1CloudStorageMyUploadPostOperation:                 []string{},
	APIV1CloudStorageMyUploadUploadIDCompletePostOperation: []string{},
	APIV1CloudStorageMyUploadUploadIDGetOperation:          []string{},
	APIV1CloudStorageMyUploadUploadIDPutOperation:          []string{},
}
